            ...
            <div className="mx-auto flex flex-col items-center justify-between gap-10 px-6 py-10 md:flex-row md:items-center md:px-12">
                <div className="max-w-md space-y-4 text-left"> {/* text on left*/}
                    ...
                    <p className="text-base text-gray-600">
                        I work on projects with a focus on impact and efficiency. My experience ranges from building award-winning AI and hardware projects that solve real-world problems, to optimizing high-scale cloud infrastructure.
                    </p>
                    <div className="pt-4">
